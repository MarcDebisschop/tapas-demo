...
const ETAPPES: Etappe[] = [
  ...
  },
  {
    ...
    titel: { nl: "Zie mensen zoals ze echt zijn", fr: "Voir les gens tels qu'ils sont vraiment", en: "See people as they really are", es: "Ver a las personas tal como son", ru: "Видеть людей такими, какие они есть" },
    body: {
      nl: "Dit is onze missie: mensen echt zien — en ze in beweging brengen. Alles op dit platform vertrekt vanuit die overtuiging.",
      fr: "Voici notre mission : voir vraiment les gens — et les mettre en mouvement. Tout sur cette plateforme part de cette conviction.",
      en: "This is our mission: to truly see people — and set them in motion. Everything on this platform starts from that conviction.",
      es: "Esta es nuestra misión: ver de verdad a las personas — y ponerlas en movimiento. Todo en esta plataforma parte de esa convicción.",
      ru: "Это наша миссия: по-настоящему видеть людей — и приводить их в движение. Всё на этой платформе исходит из этого убеждения.",
    },
    voorkeur: "onder",
  },
  {
    ...
    titel: { nl: "Werk & organisatie en Studie", fr: "Travail & organisation et Études", en: "Work & organisation and Study", es: "Trabajo & organización y Estudio", ru: "Работа и организация и Учёба" },
    body: {
      nl: "Twee werelden met één doel: mensen laten groeien. Of het nu om werk en organisatie gaat of om studie — het platform reikt tot beide.",
      fr: "Deux mondes, un seul but : faire grandir les gens. Qu'il s'agisse du travail et de l'organisation ou des études — la plateforme touche les deux.",
      en: "Two worlds with one goal: helping people grow. Whether it's work and organisation or study — the platform reaches both.",
      es: "Dos mundos con un mismo objetivo: hacer crecer a las personas. Ya sea trabajo y organización o estudio — la plataforma llega a ambos.",
      ru: "Два мира с одной целью: помогать людям расти. Будь то работа и организация или учёба — платформа охватывает оба.",
    },
    voorkeur: "boven",
  },
  {
    ...
    titel: { nl: "T4Sports", fr: "T4Sports", en: "T4Sports", es: "T4Sports", ru: "T4Sports" },
    body: {
      nl: "Een heel eigen kijk op mentale coaching bij topsporters — drivers, foci en versnellers vertaald naar sporttaal.",
      fr: "Un regard bien à nous sur le coaching mental des sportifs de haut niveau — drivers, focus et accélérateurs traduits en langage sportif.",
      en: "A distinctive take on mental coaching for top athletes — drivers, foci and accelerators translated into sports language.",
      es: "Una mirada muy propia sobre el coaching mental de deportistas de élite — drivers, focos y aceleradores traducidos al lenguaje deportivo.",
      ru: "Особый взгляд на ментальный коучинг спортсменов высокого уровня — драйверы, фокусы и ускорители на языке спорта.",
    },
    voorkeur: "boven",
  },
  {
    ...
    titel: { nl: "Landen op TaPas Lounge", fr: "Atterrir sur TaPas Lounge", en: "Landing at TaPas Lounge", es: "Aterrizar en TaPas Lounge", ru: "Посадка в TaPas Lounge" },
    body: {
      nl: "We landen op de TaPas Lounge — je thuishaven op Tapas Island. Vanaf hier ontdek je de kaart en zet je koers naar je bestemming.",
      fr: "Nous atterrissons sur le TaPas Lounge — votre port d'attache sur Tapas Island. D'ici, découvrez la carte et mettez le cap sur votre destination.",
      en: "We land at the TaPas Lounge — your home base on Tapas Island. From here you discover the map and set course for your destination.",
      es: "Aterrizamos en el TaPas Lounge — tu puerto de origen en Tapas Island. Desde aquí descubres el mapa y pones rumbo a tu destino.",
      ru: "Мы приземляемся в TaPas Lounge — вашей домашней гавани на Tapas Island. Отсюда вы откроете карту и проложите курс к своей цели.",
    },
    voorkeur: "onder",
  },
];
