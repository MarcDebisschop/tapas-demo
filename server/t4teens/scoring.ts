...
export const VONK_MSG: Record<string, VonkMsg | VonkMeta> = {
  ...
  energy_full: { icon: "battery", title: "Jij gaat graag naar school", body: "De laatste weken ga jij graag naar school. Dat is een mooie basis om op verder te bouwen: als je dat combineert met wat je gráág doet, blijf je die goesting vasthouden.", audio: "vonk-energie.mp3", script: "Iets moois: de laatste weken ga jij graag naar school. Dat is een mooie basis. Als je dat combineert met wat je graag doet, hou je die goesting vast." },
