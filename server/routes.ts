...
import { registerT4TeensRapportRoutes } from "./routes/t4teens-rapport";
...
export async function registerRoutes(
  ...
  // --- T4Teens per-leerling rapport + PDF (additief, eigen namespace) ---
  registerT4TeensRapportRoutes(app);
