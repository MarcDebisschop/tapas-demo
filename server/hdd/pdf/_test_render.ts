/* Test harness: render both variants from the Veldstroom test fixture. */
...
const DEMO_LEDEN: BoardMemberInput[] = [
  ...
  { id: 7, naam: "Menno Schreuder", rol: "Management team", samenvatting: "Systems thinker; high conscientiousness, low emotional volatility.", teamscan: { vertrouwen: 4.2, conflict: 4.1, betrokkenheid: 4.0, verantwoordelijkheid: 4.1, resultaten: 4.2 }, energy: { bron: "t4p-business", fase: 0, energie: 8 }, talent: { talentFoci: ["Strategy", "Operational", "Interrelational"], versnellers: ["Analysis", "Facilitation", "Result-orientation"], drivers: ["Be Perfect", "Be Strong", "Try Hard"], driverRisico: "matig", stratumIndicatie: 3 } },
];
